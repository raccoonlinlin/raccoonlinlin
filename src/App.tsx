...
export const Navigation: React.FC = () => {
  ...
  // 💡 關鍵修正：針對 HashRouter 優化路徑判定
  // 如果 location.hash 是 "#/works"，我們把它整理成 "/works" 來跟上面的 navLinks 精準比對
    ...
    <nav className="fixed top-0 left-0 w-full h-20 z-[100] bg-white/40 backdrop-blur-md px-4 md:px-10 flex justify-between items-center border-b border-pink-100">
      <Link to="/" className="flex items-center gap-3 group">
        ...
        <motion.div 
          initial="hidden"
          animate="visible"
          className="text-xl md:text-2xl font-black tracking-tighter text-gray-880"
        >
